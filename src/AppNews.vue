<template>
  <div class="card">
    ...
    <div v-if="isNewsOpen">
      <hr>
      <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad aliquam commodi distinctio eaque eligendi fugit illo ipsam odit quia velit?</p>
      <app-button
          v-if="!wasRead"
          color="primary"
          @action="mark">Прочесть новость</app-button>
